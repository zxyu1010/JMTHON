...
from userbot.JMTHON_main.heroku_var import config
...
JMTHON_NAME = config.JMTHON_NAME
...
JMTHON_MSG = (f"JMTHON ")
ORI_MSG = (f"مرحبا لا يمكنني ان ادعك ترسل رسائل مزعجة الرجاء الانتظار وعدم ارسال الرسائل / رد تلقائي ")
BLOCK_MSG = (f"انا لا امزح معك خذ حظر ")
JMTHON_NNAME = str(JMTHON_NAME) if JMTHON_NAME else str(JMTHON_MSG)
AFK_MSG = (f"صاحب الحساب غير متصل الرجاء الانتظار  / رد تلقائي")
BIO_MSG = (f"")
ALIVE_S_MSG = (f"I am Alone Survivor!")
ALIVE_E_MSG = (f"JMTHON  Reloaded Extra Extremely🖕🏻 ")
