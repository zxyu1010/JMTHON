...
#RUN git clone -b main https://github.com/Jasem-muhammad/JMTHON /root/userbot
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN wget https://raw.githubusercontent.com/Jasem-muhammad/JMTHON/main/sh1vamrun.py
RUN wget https://raw.githubusercontent.com/Jasem-muhammad/JMTHON/main/requirements.txt
